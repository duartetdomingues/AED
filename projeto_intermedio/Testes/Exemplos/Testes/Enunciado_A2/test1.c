...
int main(int argc, char *argv[]){
    ...
    char *filename_in;
    int option;
    int l, c, a, b, a1, b1, d, e, walls, num_cells, cell, /* conversion, */ variant, point;
    ...
    char *filename_out=(char*)malloc((point+strlen(".sol1")+1)*sizeof(char));
    ...
    int *maze = malloc((num_cells+1)* sizeof(int));
    ...
    switch(option){
        ...
        case 6:
            ...
            int *sz = (int *) malloc((num_cells+1)* sizeof(int));
            int *id = (int *) malloc((num_cells+1)* sizeof(int));
