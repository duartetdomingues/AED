 ...
 *
 * Description: This function calls BFS to colour the rooms and search all 
 * possible rooms for the maze.
 *  
 *****************************************************************************/
int makeRooms(int *maze, int l, int c, int cells_number, int walls, int *walls_array)
{
    ...
    //in case that there's no walls or all of the walls are unbreakable
 ...
 * bfs()
 *
 * Arguments: maze, k, l, c, cells_number
 * Returns: -
 *
 * Description: This function implements BFS algorithm running on a queue as
 * usual.
 *  
 *****************************************************************************/
